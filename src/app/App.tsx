...
const testimonials = [
  {
    ...
    image: imgEllipse31,
    link: "https://www.linkedin.com/in/rajesho/",
  ...
  },
  {
    ...
    image: imgEllipse32,
    link: "https://www.linkedin.com/in/azadeh-riahi-5ab3a910/",
  ...
  },
  {
    ...
    image: imgEllipse33,
    link: "https://www.linkedin.com/in/semanticcircuit/",
  ...
  },
  {
    ...
    image: imgEllipse34,
    link: "https://www.linkedin.com/in/jccss/",
  ...
  },
  {
    ...
    image: imgEllipse35,
    link: "https://www.linkedin.com/in/nageshpobbathi/",
  ...
  },
  {
    ...
    image: imgEllipse36,
    link: "https://www.linkedin.com/in/ajasper/",
  ...
  },
  {
    ...
    image: imgEllipse37,
    link: "https://www.linkedin.com/in/florianpestoni/",
  ...
  },
  {
    ...
    image: imgEllipse38,
    link: "https://www.linkedin.com/in/monicasri/",
...
function TestimonialCard({
  ...
  useEffect(() => {
    if (isExpanded) {
      // Immediately show full text when expanding
  ...
  return (
    <motion.div
      className="bg-white content-stretch flex flex-col items-center justify-center px-[16px] py-[19px] relative rounded-[20px] shrink-0 min-w-[350px] shadow-md overflow-hidden cursor-pointer"
      initial={false}
      animate={{
      ...
      onAnimationComplete={() => {
        if (!isExpanded) {
          // Only clamp text after collapse animation finishes
...
export default function App() {
  ...
  useAnimationFrame((time, delta) => {
    ...
    // When we've scrolled one full set, wrap back smoothly
    if (newX < -totalWidth) {
